 ...
 * @since  3.2
 */
class JFormFieldFrame extends \Joomla\CMS\Form\FormField // /libraries/src/Form/FormField.php
{
	/**
	 * The form field type.
	 *
...
//		if(empty($this->value))
//			return "<input type='text' readonly class='form-control form-control form-control-sm controls' value='".JText::_('Please save module for generate Url FRAME.')."'> ";
		...
		$title = $this->value ? $url : JText::_('Please save module for generate Url IFRAME.');
		$title2 = $this->value ? $this->value : JText::_('Please save module for generate Url IFRAME.');
