...
class JFormFieldGridFields extends JFormFieldSql  {//JFormField  //JFormFieldList //JFormFieldSql  //SqlField
...
//	public $fields = [];
	 ...
	 * @since  4.0.0
	 */
	protected $layout = 'gridfields';//'joomla.form.field.gridfields';//GridFields   //fields.gridfields
//	protected $layout = 'fields.gridfields';//'joomla.form.field.gridfields';//GridFields   //fields.gridfields
	 ...
	 * @var  string
	 */
//	protected $renderLayout = 'joomla.form.field.gridfields';
...
//        $this->moduleid = $mod_id = $this->form->getValue('id',null,0); 
		...
		$this->element = simplexml_load_string('<field/>');
...
//toPrint($columnsXML,'$columnsXML',0);
...
//		$isValueExist = is_null($value) == false;
...
//	toPrint( $Element['class'],$Element['name']);
//toPrint( $Element);
...
//$data['class'] = 'GridFields';
		$html = $this->getRenderer(strtolower($this->layout))->addIncludePath($layoutPath1)->addIncludePath($layoutPath2)->render($data);
		
//toPrint('abraCadabra','$this',0,'message',true);
//toPrint($this->layout, '$this->layout', 0, 'message', true);
//toPrint($data, '$data', 0, 'message', true); 
//toPrint($this->getRenderer(strtolower($this->layout))->addIncludePath($layoutPath1)->addIncludePath($layoutPath2), 'Renderer', 0, 'message', true);
...
//class_alias('JFormFieldGridFields', 'Joomla\CMS\Form\Field\GridFieldsField');
//class_alias('JFormFieldGridFields', 'GridFieldsField');
class_alias('JFormFieldGridFields', 'GridFieldsField');
?> 